...
# Modified by David Maxwell to switch the Tracking API to the ReconnectingTweetStream
    ...
    def _init_conn(self):
        ...
        try:
            ...
            if exception.code == 401:
				...
				raise ConnectionError("Slow down!")
...
class TrackStream(ReconnectingTweetStream):
    ...
    def __init__(self, user, password, keywords, url="track", reconnects = 3, retry_wait = 5, **kwargs):
